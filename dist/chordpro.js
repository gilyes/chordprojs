...
function parse(source) {
  ...
  source.split('\n').forEach(function (line) {
    if (!line.match(commentRegex)) {
      ...
      if (hasDirective(parsedLine, 'sot')) {
        isBetweenTabDirectives = true;
      } else if (hasDirective(parsedLine, 'eot')) {
        isBetweenTabDirectives = false;
      } else {
        if (isBetweenTabDirectives) {
          parsedLine = [];
          parsedLine.push({ lyrics: line });
        }
      }
...
function hasDirective(parsedLine, directiveType) {
...
function _formatParsedLine(parsedLine) {
  ...
  try {
    for (var _iterator2 = parsedLine[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var parsedLineSegment = _step2.value;
...
function _getDirectiveValue(parsedLines, directiveType) {
  ...
  try {
    for (var _iterator3 = parsedLines[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      try {
        for (var _iterator4 = parsedLine[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var parsedLineSegment = _step4.value;
